    ...
    <table :class="['vuetable', css.tableClass, css.tableBodyClass]">
      ...
      <tbody v-cloak class="vuetable-body">
        <template v-for="(item, itemIndex) in tableData">
                ...
                <template v-if="isSpecialField(field.name)">
                  ...
                  >
                    <component :is="extractArgs(field.name)"
                               :row-details="detailRowFields" :row-data="item" :row-index="itemIndex" :row-field="field.sortField"
                    ></component>
                  </td>
          ...
          <template v-if="useDetailRow && isDetailRowFieldsNotEmpty">
            <transition :name="detailRowTransition" :key="itemIndex">
              ...
              >
                <td :colspan="countVisibleFields">
                  <component :is="detailRowComponent" :row-details="detailRowFields" :row-data="item" :row-index="itemIndex"></component>
                </td>
              </tr>
            </transition>
          </template>
...
export default {
  ...
  computed: {
    version: () => VERSION,
    isDetailRowFieldsNotEmpty () {
      return this.detailRowFields.length !== 0
    },
    useDetailRow () {
